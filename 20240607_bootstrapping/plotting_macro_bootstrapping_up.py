...
if __name__ == '__main__':
    ...
    plot_ratio_bootstrapped(hist_comp_pt10, hist_list_pt10, label_list,
            arg_index = 0, part_index = 0, y_scale = 'log')
    ...
    plot_ratio_bootstrapped(hist_comp_eta11, hist_list_eta11, label_list,
            arg_index = 4, part_index = 0, y_scale = 'log', plot_all = False, ratio_ylim=[0.90, 1.10])
    ...
    plot_ratio_bootstrapped(hist_comp_pt18, hist_list_pt18, label_list,
            arg_index = 0, part_index = 0, y_scale = 'log')

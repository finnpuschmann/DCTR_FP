#!/bin/bash
# file name: submit_hvq_dileptonic_HadronLevelAll-Off_FSR-Off_MPI-Off.sh
...
# min pt 15
python ./jet_multiplicity_hvq_dileptonic_HadronLevelAll-Off_FSR-Off_MPI-Off.py -p 15.0 -l $LHE

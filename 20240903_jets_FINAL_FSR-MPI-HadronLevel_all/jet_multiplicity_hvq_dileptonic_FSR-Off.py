...
# save shower
P0 = np.array(P0)
np.save(f'{dir}/converted_lhe_hvq_dileptonic_1M_{LHE}_FSR-Off.npy', P0)
print(f'{np.shape(P0) = }')

# save multiplicity and jet observables
nJets = np.array(nJets)
np.save(f'{dir}/jet_multiplicity_hvq_dileptonic_1M_{LHE}_FSR-Off.npy', nJets)
print(f'{np.shape(nJets) = }')

jets_4vectors = np.array(jets_4vectors)
np.save(f'{dir}/jet_4vectors_hvq_dileptonic_1M_{LHE}_FSR-Off.npy', jets_4vectors)

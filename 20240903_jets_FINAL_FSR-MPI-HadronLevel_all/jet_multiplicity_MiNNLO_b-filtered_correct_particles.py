...
# save shower
P0 = np.array(P0)
np.save(f'{dir}/converted_lhe_MiNNLO_10K_{LHE}_b-filtered.npy', P0)
print(f'{np.shape(P0) = }')
...
np.save(f'{dir}/leptons_array_MiNNLO_10K_{LHE}_b-filtered.npy', leptons_array)
print(f'{np.shape(leptons_array) = }')

# save b_quark array
b_quark_array = np.array(b_quark_array)
np.save(f'{dir}/b_quarks_MiNNLO_10K_{LHE}_b-filtered.npy', b_quark_array)

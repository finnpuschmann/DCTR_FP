...
# save shower
P0 = np.array(P0)
np.save(f'{dir}/converted_lhe_MiNNLO_10K_{LHE}_HadronLevelAll-Off.npy', P0)
print(f'{np.shape(P0) = }')

# save multiplicity and jet observables
np.save(f'{dir}/jet_multiplicity_MiNNLO_10K_{LHE}_HadronLevelAll-Off.npy', nJets)
print(f'{np.shape(nJets) = }')

np.save(f'{dir}/jet_4vectors_MiNNLO_10K_{LHE}_HadronLevelAll-Off.npy', jets_4vectors)

...
pythia.readString("Beams:LHEF = /nfs/dust/cms/user/amoroso/powheg/POWHEG-BOX-V2/ttJ_MiNNLOPS_v1.0_beta1/decay-ll/pwgevents-1000.lhe") # the LHEF to read from
...
np.save('jet_multiplicity_MiNNLO.npy', nJets)

print(np.shape(nJets))

print(nJets[:20])

np.save('jet_4vectors_MiNNLO.npy', jets_4vectors)

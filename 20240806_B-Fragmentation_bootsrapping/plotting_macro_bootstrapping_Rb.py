...
def plot_ratio_bootstrapped(in_hists, hist_list, label_list,
    ...
    if part_label is not None:
        save_folder = f'./plots/{denominator}/{part_label}'
    elif part_index == 0:
...
def plot_square_matrix_heatmap(matrix, title, variable_labels = None, vmin=None, vmax=None, savefig = './plots/matrix.pdf'):
    font = {'size'   : 12}
    rc('font', **font)
...
if __name__ == '__main__':
    ...
    label_list = [r'$r_{b}=1.056$', r'$r_{b}=0.855 \; wgt.$ (mean)', r'$r_{b}=0.855$']
    ...
    # pt(B) for 10 bins
    hist_comp = np.load('./plots/pT_10bin_hist_comp_1M_50iter.npy', allow_pickle=True)
    hist_list = np.load('./plots/pT_10bin_hist_list_1M_50iter.npy', allow_pickle=True)
    ...
    plot_ratio_bootstrapped(
        ...
        part_index = 0,
        y_scale = 'log',
        save_prefix = '1M_50iter',
        denominator=r'$r_{b}=1.056$',
    ...
    plot_ratio_bootstrapped_ratio_only(
        hist_comp,
        hist_list,
        label_list,
        loc1 = 'upper left',
    ...
    # pt(B) for 50 bins
    hist_comp = np.load('./plots/pT_50bin_hist_comp_1M_50iter.npy', allow_pickle=True)
    hist_list = np.load('./plots/pT_50bin_hist_list_1M_50iter.npy', allow_pickle=True)
    ...
    # x=b for 50 bins
    hist_comp = np.load('./plots/xb_50bin_hist_comp_1M_50iter.npy', allow_pickle=True)
    hist_list = np.load('./plots/xb_50bin_hist_list_1M_50iter.npy', allow_pickle=True)
    ...
    # x=b for 11 bins
    hist_comp = np.load('./plots/xb_11bin_hist_comp_1M_50iter.npy', allow_pickle=True)
    hist_list = np.load('./plots/xb_11bin_hist_list_1M_50iter.npy', allow_pickle=True)
